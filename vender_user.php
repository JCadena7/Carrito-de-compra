...
?>
	<div class="col-xs-12">
		...
		<table class="table table-bordered">
			...
			<tbody>
				...
				<tr>
					...
					<td><a class="btn btn-danger" href="<?php echo "quitarDelCarrito.php?indice=" . $indice?>" onclick="return confirmBorrar()">Borrar</a></td>
				</tr>
				<?php } ?>
			</tbody>
		</table>
		...
		<form action="./terminarVenta.php" method="POST">
			...
			<a href="./cancelarVenta.php" class="btn btn-danger" onclick="return confirmarCancelar()">Cancelar venta</a>
		</form>
	</div>
